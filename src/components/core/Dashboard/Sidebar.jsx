...
const Sidebar=()=>{
    ...
    return(
        <div className="flex min-w-[222px] flex-col border-r-[1px] border-r-richblack-700 h-[cal[100vh-3.5rem]] bg-richblack-800 py-10">
         ...
         <div className="flex flex-col">
            ...
            onClick={()=>setConfirmationModal({
                text1:"Are you sure",
                text2:"You will be logout of ypur account",
                btn1Text:"Logout",
                btn2Text:"cancel",
